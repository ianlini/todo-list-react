...
var TodoApp = function (_React$Component) {
  ...
  _createClass(TodoApp, [{
    ...
    value: function checkItem(idx) {
      ...
      if (this.state.markAll && !this.state.items[idx]['checked']) this.state.markAll = false;
      this.setState({ items: this.state.items,
    ...
    key: 'markAll',
    value: function markAll(event) {
      var markAll = this.state.markAll;
      if (!markAll) {
        markAll = true;
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'section',
            { className: 'main' },
            React.createElement('input', { className: 'toggle-all', type: 'checkbox', onChange: this.markAll.bind(this), checked: this.state.markAll }),
            React.createElement(
              'label',
              { htmlFor: 'toggle-all' },
